...
#used for z scoreing latencies to block 0 (not used in paper but cool to have)
ZSDict={'263':64.9,'A03':15.95,'251':6.42,'252':12.01,'256':7.936,'257':29.85,'282':47.64,'283':4.93,'284':19.80,'321':11.62,'318':9.09,'319':7.809,'320':6.58}
ZSTDDict={'263':77.57,'A03':11.36,'251':8.94,'252':12.19,'256':6.99,'257':75.91,'282':36.86,'283':6.50,'284':32.29,'321':10.99,'318':20.03,'319':8.722,'320':5.92}
ZSFDict={'263':6.22,'A03':2.26,'251':1.214,'252':1.48,'256':1.98,'257':2.43,'282':1.95,'283':1.19,'284':2.05,'321':1.65,'318':1.67,'319':1.86,'320':2.116}
ZSTDFDict={'263':5.49,'A03':0.94,'251':0.36,'252':1.02,'256':0.49,'257':4.72,'282':0.21,'283':0.41,'284':1.86,'321':0.47,'318':0.63,'319':1.19,'320':1.64}
...
#Gets all the stamps and block type for each trial. normalizes times to the first cue onset
	...
	actionlatencies2=actionlatencies.copy()
	actionlatencies=numpy.array(actionlatencies)
	actionlatencies=(actionlatencies-ZSDict[subj])/ZSTDDict[subj]#numpy.mean(b1lat))/numpy.std(b1lat) #ZSDict[subj]
	foodlatencies2=foodlatencies.copy()
	foodlatencies=numpy.array(foodlatencies)
	foodlatencies=(foodlatencies-ZSFDict[subj])/ZSTDFDict[subj]#-numpy.mean(fb1lat))/numpy.std(fb1lat)
	actionlatencies=actionlatencies.tolist()
